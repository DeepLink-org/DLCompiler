...
python python/tutorials/gluon/09-maca-matmul_tn_1.py

# FlashAttention forward：主例子
python python/tutorials/gluon/10-maca-flash-fwd-fused-single-kernel2.py \
...
`09-maca-matmul_tn_1.py` 计算 `C = A × B`。其中 B 的逻辑 shape 为 `(K,N)`，但测试构造中用
