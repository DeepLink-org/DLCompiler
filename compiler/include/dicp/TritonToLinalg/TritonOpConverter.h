...
struct FlipOpConverter : public OpConversionPattern<triton::dicp::FlipOp> {
  using OpConversionPattern<triton::dicp::FlipOp>::OpConversionPattern;

  LogicalResult
  matchAndRewrite(triton::dicp::FlipOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override;

  static constexpr StringRef baseFuncName = "triton_flip";
};

struct SortOpConverter : public OpConversionPattern<triton::dicp::SortOp> {
  using OpConversionPattern<triton::dicp::SortOp>::OpConversionPattern;

  LogicalResult
  matchAndRewrite(triton::dicp::SortOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override;
};
...
class IndexPutConverter : public OpConversionPattern<triton::dicp::IndexPutOp> {
public:
  using OpConversionPattern<triton::dicp::IndexPutOp>::OpConversionPattern;
  LogicalResult
  matchAndRewrite(triton::dicp::IndexPutOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override;
...
class GatherOutToUbConverter
    : public OpConversionPattern<triton::dicp::GatherOutToUbOp> {
public:
  using OpConversionPattern<triton::dicp::GatherOutToUbOp>::OpConversionPattern;
  LogicalResult
  matchAndRewrite(triton::dicp::GatherOutToUbOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override;
...
class ScatterUbToOutConverter
    : public OpConversionPattern<triton::dicp::ScatterUbToOutOp> {
public:
  using OpConversionPattern<
      triton::dicp::ScatterUbToOutOp>::OpConversionPattern;
  LogicalResult
  matchAndRewrite(triton::dicp::ScatterUbToOutOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override;
...
class IndirectLoadConverter
    : public OpConversionPattern<triton::dicp::IndirectLoadOp> {
public:
  using OpConversionPattern<triton::dicp::IndirectLoadOp>::OpConversionPattern;
  LogicalResult
  matchAndRewrite(triton::dicp::IndirectLoadOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override;
...
class IndirectStoreConverter
    : public OpConversionPattern<triton::dicp::IndirectStoreOp> {
public:
  using OpConversionPattern<triton::dicp::IndirectStoreOp>::OpConversionPattern;
  LogicalResult
  matchAndRewrite(triton::dicp::IndirectStoreOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override;
...
class IndexSelectSimdConverter
    : public OpConversionPattern<triton::dicp::IndexSelectSimdOp> {
public:
  explicit IndexSelectSimdConverter(MLIRContext *context);
  using OpConversionPattern<
      triton::dicp::IndexSelectSimdOp>::OpConversionPattern;

  LogicalResult
  matchAndRewrite(triton::dicp::IndexSelectSimdOp op, OpAdaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override;
};
