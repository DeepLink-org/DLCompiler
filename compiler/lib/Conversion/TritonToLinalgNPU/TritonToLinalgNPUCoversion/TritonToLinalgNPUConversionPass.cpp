...
class TritonToLinalgNPUCoversionPass
    : public TritonToLinalgNPUCoversionBase<TritonToLinalgNPUCoversionPass> {
...
mlir::dicp::linked::createTritonToLinalgNPUCoversionPass() {
  return std::make_unique<TritonToLinalgNPUCoversionPass>();
}
