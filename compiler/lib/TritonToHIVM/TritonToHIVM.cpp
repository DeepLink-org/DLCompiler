...
#include "dicp/TritonToHIVM/Passes.h.inc"
} // namespace triton
} // namespace mlir
...
struct TritonCustomOpToHIVMSyncOpConversion
    : OpRewritePattern<triton::dicp::CustomOp> {
  using OpRewritePattern<triton::dicp::CustomOp>::OpRewritePattern;

  LogicalResult matchAndRewrite(triton::dicp::CustomOp op,
