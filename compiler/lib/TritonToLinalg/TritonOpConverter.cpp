...
#include "dicp/TritonToLinalg/MaskAnalysis.h"
...
LogicalResult
FlipOpConverter::matchAndRewrite(triton::dicp::FlipOp op, OpAdaptor adaptor,
                                 ConversionPatternRewriter &rewriter) const {
  Value src = adaptor.getSrc();
...
LogicalResult
SortOpConverter::matchAndRewrite(triton::dicp::SortOp op, OpAdaptor adaptor,
                                 ConversionPatternRewriter &rewriter) const {
  Value src = adaptor.getSrc();
  auto rankedSrcTy = cast<RankedTensorType>(src.getType());
...
LogicalResult
IndexPutConverter::matchAndRewrite(triton::dicp::IndexPutOp op,
                                   OpAdaptor adaptor,
                                   ConversionPatternRewriter &rewriter) const {
  auto loc = op.getLoc();
...
LogicalResult GatherOutToUbConverter::matchAndRewrite(
    triton::dicp::GatherOutToUbOp op, OpAdaptor adaptor,
    ConversionPatternRewriter &rewriter) const {
  auto loc = op.getLoc();
...
LogicalResult ScatterUbToOutConverter::matchAndRewrite(
    triton::dicp::ScatterUbToOutOp op, OpAdaptor adaptor,
    ConversionPatternRewriter &rewriter) const {
  auto loc = op.getLoc();
...
LogicalResult IndirectLoadConverter::matchAndRewrite(
    triton::dicp::IndirectLoadOp op, OpAdaptor adaptor,
    ConversionPatternRewriter &rewriter) const {
  auto loc = op.getLoc();
...
LogicalResult IndirectStoreConverter::matchAndRewrite(
    triton::dicp::IndirectStoreOp op, OpAdaptor adaptor,
    ConversionPatternRewriter &rewriter) const {
  auto loc = op.getLoc();
...
IndexSelectSimdConverter::IndexSelectSimdConverter(MLIRContext *context)
    : OpConversionPattern<triton::dicp::IndexSelectSimdOp>(context) {}

LogicalResult IndexSelectSimdConverter::matchAndRewrite(
    triton::dicp::IndexSelectSimdOp op, OpAdaptor adaptor,
    ConversionPatternRewriter &rewriter) const {
  auto loc = op.getLoc();
