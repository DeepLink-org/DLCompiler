...
def pow(arg0, arg1, _semantic=None):
    return core.extern_elementwise(
        "", "", [arg0, arg1], {
            ...
            (core.dtype("fp16"), core.dtype("fp32")): ("__hmf_powf", core.dtype("fp32")),
            (core.dtype("bf16"), core.dtype("fp32")): ("__hmf_powf", core.dtype("fp32")),
            (core.dtype("fp32"), core.dtype("fp16")): ("__hmf_powf", core.dtype("fp32")),
            (core.dtype("fp32"), core.dtype("bf16")): ("__hmf_powf", core.dtype("fp32")),
