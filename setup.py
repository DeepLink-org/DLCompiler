...
def change_backend_path():
    source_dir = os.path.join(root_dir, "backend")
    target_dir = os.path.join(root_dir, "ascend/backend")
...
def change_CMakeLists_path():
    source_dir = os.path.join(root_dir, "ascend/CMakeLists.txt.ascend")
    target_dir = os.path.join(root_dir, "CMakeLists.txt")

    shutil.copy(source_dir, target_dir)

change_CMakeLists_path()
...
setup(
    ...
    url="https://github.com/DeepLink-org/Triton/tree/main",
    extras_require={
        "build": [
            "cmake>=3.20",
            "lit",
