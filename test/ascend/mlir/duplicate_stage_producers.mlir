// RUN: %dicp_opt %s --duplicate-stage-producers | %FileCheck %s
//
// CHECK-LABEL: func.func @_matmul_relu_fwd
// CHECK-NOT: dicp.tmp.stage.op_had_fused
// CHECK-COUNT-1: linalg.matmul {dicp.tmp.stage.anchor_op_to_tile_tag.stage_{{[0-9]+}}.sub_0.u_1
// CHECK-COUNT-1: arith.maxnumf %{{.+}} : tensor<256x128xf32>
