...
inline void registerDICPDialects(mlir::DialectRegistry &registry) {
  ...
  dicp::LinalgExt::registerPipelineLoopUnrollPass();
  dicp::LinalgExt::registerCanonicalizeTileableOpsPass();
  dicp::LinalgExt::registerStageTilingPlanPass();
  dicp::LinalgExt::registerApplyTilingPlanPass();
  dicp::LinalgExt::registerDuplicateStageProducersPass();
  dicp::LinalgExt::registerDeLinalgizePass();
  dicp::LinalgExt::registerFuseLoopPass();
  dicp::LinalgExt::registerLowerForallToForPass();
  dicp::LinalgExt::registerUnrollStageLoopsPass();
  dicp::LinalgExt::registerShrinkBuffersPass();
  dicp::LinalgExt::registerPrepareInputBundleSchedulingPass();
  dicp::LinalgExt::registerScheduleInputBundlesPass();
  dicp::LinalgExt::registerVectorTilingPipelinePass();
